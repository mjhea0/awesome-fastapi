...
- [RapidKit](https://github.com/getrapidkit/rapidkit-npm) - Workspace platform CLI for scaffolding production-ready FastAPI services with clean architecture, 27+ plug-and-play modules (auth, database, cache, payments, etc.), and workspace-first lifecycle management.
