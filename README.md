...
- [FXMacroData](https://github.com/fxmacrodata/fxmacrodata) - Real-time forex macroeconomic data API serving central bank announcements for 18 currencies, with MCP server and OAuth support.
