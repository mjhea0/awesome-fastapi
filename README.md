...
- [BillingWatch](https://github.com/rmbell09-lang/BillingWatch) - Self-hosted billing anomaly detector with Stripe webhook ingestion, anomaly detection, and alerting, built with FastAPI.
