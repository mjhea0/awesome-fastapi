...
- [Uvicorn Poetry Project Template](https://github.com/max-pfeiffer/uvicorn-poetry-project-template) Cookiecutter template for quickly spinning up a containerised FastAPI application on Kubernetes. Provides Poetry for dependency management. 
