...
- [IndieStack](https://indiestack.fly.dev) - A production indie SaaS discovery engine using FastAPI, SQLite with FTS5 search, and an MCP server integration for AI coding tools.
