...
- [Full Stack FastAPI and MongoDB - Base Project Generator]([https://github.com/mongodb-labs/full-stack-fastapi-mongodb]) - Full stack, modern web application generator, which includes FastAPI, MongoDB, Docker, Celery, React frontend, automatic HTTPS and more (developed by MongoDB).
