...
- [Car Carer](https://github.com/Greal-dev/car-carer) - AI-powered self-hosted car maintenance tracker. Upload invoices/photos, AI extracts structured data, intelligent chat queries history. Uses Claude + Gemini.
