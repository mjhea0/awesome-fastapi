...
- [FIM Agent](https://github.com/fim-ai/fim-agent) - AI-powered Connector Hub with a FastAPI backend. Features dynamic DAG planning, ReAct agent loop, MCP client support, RAG with grounded generation, and a connector platform that turns any API into agent tools. Includes a Next.js portal frontend.
