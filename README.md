...
- [LLM-Shield-Proxy](https://github.com/ninadphalak/LLM-Shield-Proxy) - A lightweight, zero-egress reverse proxy for sub-millisecond PII redaction and re-hydration on streaming LLM responses (SSE).
