...
- [FastAPI Code Generator](https://github.com/koxudaxi/fastapi-code-generator) - Creates FastAPI app from an openapi file enabling copy & paste kind of schema driven development.
