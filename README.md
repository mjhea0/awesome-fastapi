...
-  [ForgeKit](https://jefritzandrade.gumroad.com/l/tojaa) - Production-ready FastAPI SaaS starter kit with auth (JWT + OAuth2), Stripe billing, Claude AI streaming, multi-tenancy, RBAC, admin dashboard, Docker Compose, and CI/CD.
