...
- [FastAPI RBAC Admin](https://github.com/fastapi-practices/fastapi_best_architecture) - RBAC privilege control system with a unique pseudo-triple architectural model design.
