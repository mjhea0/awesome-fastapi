...
- [FastAPI-Graphql-Strawberry-Mongodb-Template](https://github.com/bhavberi/FastAPI-Graphql-Strawberry-Mongodb-Template) - Template/Boilerplate Code for a Service using FastAPI + Strawberry-Graphql + MongoDB, containing example code for various variations of queries, mutations, types and models.
